...
void init_transaction(py::module &m)
{
    py::class_<Transaction>(m, "Transaction")
        ...
        .def_readonly("m_creationTimeStamp", &Transaction::m_creationTimeStamp)
        ...
        .def_readonly("m_rules", &Transaction::m_rules)
        ...
        .def_readonly("m_rulesMessages", &Transaction::m_rulesMessages)
        ...
        .def_readonly("m_timeStamp", &Transaction::m_timeStamp)
